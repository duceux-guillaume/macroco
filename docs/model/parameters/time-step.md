...
Default of 1.0 year provides stable results for all presets (Collapse, Technotopia, Ecotopia). dt-sensitivity testing (`diagnose --stability-check`) confirms all variables converge within 3% between dt=1.0 and dt=0.25. Pollution peak is the most dt-sensitive variable (~2.4% drift).
