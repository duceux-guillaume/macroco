...
| REQ-042 | Sidebar-centric layout principle | Done (exempt: Layout/positioning concern; not testable with jsdom) | — |
...
| `frontend/src/lib/utils/feedback-url.test.ts` | REQ-028 |
